...
\begin{tikzpicture}
  ...
  \draw[EdgeStyle] (my second commit) to (my commit);
    ...
    \node[SectionNode, left = 80mm of shared parent, text width = 50, align = center, label={\texttt{master}}] (shared parent 2) {shared parent};
    \node[SectionNode, text width = 60, above = 15mm of shared parent 2, align = center, xshift = -30mm, label={\texttt{mybranch}}] (my commit 2) {my commit};
