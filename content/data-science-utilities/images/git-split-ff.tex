...
\begin{tikzpicture}
  ...
  \draw[EdgeStyle] (my second commit) to (my commit);
    ...
    \node[SectionNode, right = 80mm of shared parent, text width = 50, align = center] (shared parent 2) {shared parent};
    ...
    \node[SectionNode, above = 15mm of shared parent 2, text width = 50, align = center, xshift = 30mm, label={\texttt{theirbranch}}] (their commit 2) {their commit};  
      \node[SectionNode, text width = 60, above = 15mm of my commit 2, align = center, label={\texttt{mybranch,master}}] (my second commit 2) {my second commit};
